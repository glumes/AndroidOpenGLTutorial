...
/**
 * Created by glumes on 23/07/2018
 */
public class SpecularBall {
    ...
    public SpecularBall(Resources res) {
        //调用初始化顶点数据的方法
        initVertexData();
        //调用初始化着色器的方法
        initShader(res);
    ...
    public void initShader(Resources res) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("light/specular_vertex.glsl", res);
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("light/specular_fragment.glsl", res);
        // 基于顶点着色器与片元着色器创建程序
