...
public class LoadedObjectVertexNormal {
    ...
    public LoadedObjectVertexNormal(Resources res, float[] vertices, float[] normals) {
        //初始化顶点数据
    ...
    public void intShader(Resources res) {
        //加载顶点着色器的脚本内容
        mVertexShader = TextResourceReader.readTextFileFromAsset(res, "teapot_vertex.glsl");
        //加载片元着色器的脚本内容
        mFragmentShader = TextResourceReader.readTextFileFromAsset(res, "teapot_frag.glsl");
        //基于顶点着色器与片元着色器创建程序
