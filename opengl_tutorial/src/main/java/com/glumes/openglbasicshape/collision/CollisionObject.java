...
public class CollisionObject {
    ...
    public CollisionObject(Resources res, float[] vertices, float[] normals)
    {
        //初始化顶点坐标与着色数据
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("collision/vertex.glsl", res);
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("collision/frag.glsl", res);
        //基于顶点着色器与片元着色器创建程序
