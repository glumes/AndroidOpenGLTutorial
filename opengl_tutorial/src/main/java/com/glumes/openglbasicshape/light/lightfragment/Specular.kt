 ...
 * @Author  glumes
 */
class MirrorLight : Fragment() {

    lateinit var surfaceView: SpecularView

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        surfaceView = SpecularView(context!!)
...
class SpecularView(var mContext: Context) : GLSurfaceView(mContext) {

    private val TOUCH_SCALE_FACTOR = 180.0f / 320//角度缩放比例
    private var mRenderer: SpecularRenderer//场景渲染器
    lateinit var ball: SpecularBall//球
    ...
    init {
        ...
        mRenderer = SpecularRenderer()    //创建场景渲染器
    ...
    private inner class SpecularRenderer : GLSurfaceView.Renderer {
        ...
        override fun onSurfaceCreated(gl: GL10, config: EGLConfig) {
            ...
            //创建球对象
            ball = SpecularBall(mContext.resources)
            //打开深度检测
