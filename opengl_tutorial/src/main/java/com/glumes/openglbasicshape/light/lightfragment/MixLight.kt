...
import com.glumes.importobject.light.LightMixBall
import com.glumes.importobject.light.SpecularBall
...
class MixLight : Fragment() {
    ...
    lateinit var surfaceView: LightMixView

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        surfaceView = LightMixView(context!!)
...
class LightMixView(var mContext: Context) : GLSurfaceView(mContext) {

    private val TOUCH_SCALE_FACTOR = 180.0f / 320//角度缩放比例
    private var mRenderer: LightMixRenderer//场景渲染器
    lateinit var ball: LightMixBall//球
    ...
    init {
        ...
        mRenderer = LightMixRenderer()    //创建场景渲染器
    ...
    private inner class LightMixRenderer : GLSurfaceView.Renderer {
        ...
        override fun onSurfaceCreated(gl: GL10, config: EGLConfig) {
            ...
            //创建球对象
            ball = LightMixBall(mContext.resources)
            //打开深度检测
